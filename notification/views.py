...
def notification(request, id):
    ...
    freelancer = Account.objects.raw(f'select a.*, n.link, n.message, n.read, n.id as "notification_id" from account_account a join notification_notification n on n.sender_id = a.id where n.receiver_id = {request.user.id};')
